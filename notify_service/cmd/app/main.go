...
func main() {
	...
	jwtService := jwtAuth.NewServiceWithCookieName(os.Getenv("JWT_SECRET"), 15*time.Minute, 7*24*time.Hour, "notify_service_access_token", "notify_service_refresh_token")
